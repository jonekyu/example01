...
INSERT INTO PRODUCTS(PCODE,PNAME,PPRICE) 
VALUES(101,'LG 냉장고',2800000);
INSERT INTO PRODUCTS(PCODE,PNAME,PPRICE) 
VALUES(102,'LG 세탁기',2300000);
INSERT INTO PRODUCTS(PCODE,PNAME,PPRICE) 
...
INSERT INTO PRODUCTS(PCODE,PNAME,PPRICE) 
VALUES(SEQ_PCODE.NEXTVAL,'삼성 스타일러',3000000);
...
S.SPRICE, S.QNT, S.SPRICE*S.QNT SSUM,
P.PPRICE, TO_CHAR(S.SDATE,'YYYY-MM-DD HH:MI:ss') FDATE 
FROM SALE S, PRODUCTS P
WHERE S.PCODE = P.PCODE
...
SELECT PCODE, PNAME, SUM(QNT) sum_qnt, SUM(SPRICE*QNT) sum_price
FROM VIEW_SALE 
